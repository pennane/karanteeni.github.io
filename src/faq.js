        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(Accordion, { id: "yle4", question: "Tahtoisin yll\xE4pit\xE4j\xE4ksi. Kuinka voin saavuttaa sen?", target: "ylecol4", answer: ['Käy lukemassa ohjeet ', React.createElement(
                        ...
                        { id: "link", href: "/yphaku" },
                        "t\xE4\xE4lt\xE4"
                    ), ' ja lähetä hakemus Karanteenin sähköpostiin.'] }),
                React.createElement(Accordion, { id: "yle5", question: "Kuinka monta blockia spawnissa on?", target: "ylecol5", answer: ['On. ', React.createElement(
                        "em",
                        null,
                        "-PreGauris"
                    )] }),
                React.createElement(Accordion, { id: "yle6", question: "Apua! Ei ole oikeuksia komentoon, vaikka pit\xE4isi olla.", target: "ylecol6", answer: "Koita poistua palvelimelta ja liitty\xE4\r uudelleen. Mik\xE4li ongelma ei korjaantunut, nyk\xE4ise yll\xE4pit\xE4j\xE4\xE4 hihasta." }),
                React.createElement(Accordion, { id: "yle7", question: "Kuinka p\xE4\xE4sen korkeammalle tasolle?", target: "ylecol7", answer: ['Pelaamalla. Rankeista löydät lisätietoa ', React.createElement(
                        "a",
                        { id: "link", href: "rankit" },
                        "t\xE4\xE4lt\xE4"
                    ), '.'] }),
                React.createElement(Accordion, { id: "yle8", question: "L\xF6ysin palvelimelta peli\xE4 rikkovan vian. Mit\xE4 teen?", target: "ylecol8", answer: ['Ota yhteyttä ylläpitäjään joko palvelimella', ' tai liity Karanteenin Discordiin ja valitse sieltä kanava "Bugit ja parannusehdotukset". Mikäli bugia voi hyväksikäyttää, pidä se omana tietonasi, äläkä kerro muille pelaajille.', React.createElement("br", null), React.createElement("br", null), 'Bugin hyväksikäyttö on ', React.createElement(
                        "b",
                        null,
                ...
                React.createElement(Accordion, { id: "yle9", question: "Voinko k\xE4ytt\xE4\xE4 kahta tili\xE4 palvelimella?", target: "ylecol9", answer: ['Voit, mutta tilit eivät saa hyötyä toisistaan. Tähän lukeutuu', ' mm. tavarapakkausten ja äänestysrahojen siirtäminen toiselle tilille. Pelitilit eivät saa olla yhtä aikaa palvelimella.'] }),
                React.createElement(Accordion, { id: "yle10", question: "Kuinka usein maailma nollataan?", target: "ylecol10", answer: ['Maailma nollataan yleensä noin puolen vuoden välein,', ' mutta ei tapahdu automaationa. Yleensä maailman nollaus myös tähdätään seuraavan Minecraftin suuren versiopäivityksen kohdille.', React.createElement("br", null), React.createElement("br", null), 'Nether ja End sitä vastoin nollataan kerran kuukaudessa, yleensä joka kuukauden alussa.'] }),
                ...
                React.createElement(Accordion, { id: "prot2", question: "Apua! Taloani on grieffattu!", target: "protcol2", answer: "Ei h\xE4t\xE4\xE4. P\xE4\xE4set Karanteenin Discordiin /discord komennolla, tai voit\r nyk\xE4ist\xE4 jo paikalla olevaa yll\xE4pit\xE4j\xE4\xE4 hihasta. Joka tapauksessa saat grieffatun talosi kuntoon, sek\xE4 tavarat takaisin. Grieffaaja sit\xE4 vastoin saa porttikiellon\r palvelimelle." }),
                ...
                React.createElement(Accordion, { id: "eco3", question: "En saanut \xE4\xE4nestyksess\xE4 pennej\xE4.", target: "ecol3", answer: "Varmista, ett\xE4 olet ensikerralla Survivalin p\xE4\xE4maassa. Yll\xE4pito\r antanee rahat manuaalisesti." }),
                ...
                React.createElement(Accordion, { id: "home2", question: "En pysty teleporttaamaan, poistamaan tai asettamaan koteja. Internal error, wat do?", target: "homecol2", answer: "Sano l\xE4himm\xE4lle\r yll\xE4pit\xE4j\xE4lle asiasta. Todenn\xE4k\xF6isesti joku tai jotkin kodeistasi ovat korruptoituneet ja joudumme poistamaan ne manuaalisesti. Mik\xE4li yll\xE4pitoa ei ole paikalla,\r liity Karanteenin Discord palvelimelle ja kerro ongelmastasi Naxray:lle, Jomelle tai Nuublesille." }),
                React.createElement(Accordion, { id: "home3", question: "Saanko asettaa kodin Netheriin tai Endiin?", target: "homecol3", answer: "Saat, mutta emme suosittele. Nether ja End resetoidaan\r kuukauden v\xE4lein, mik\xE4 voi aiheuttaa kodin korruptoitumista ja sinun kuoleman. T\xE4m\xE4 tarkoittaa siis sit\xE4, ett\xE4 saatat kuolla jos k\xE4yt\xE4t kotia resetoinnin j\xE4lkeen.\r Yll\xE4pito ei ole velvollinen palauttamaan tavaroitasi." }),
                React.createElement(Divider, { id: "rangaistukset", name: "Rangaistukset" }),
                React.createElement(Accordion, { id: "pun1", question: "Montako rangaistusta voin saada?", target: "puncol1", answer: "Riippuu k\xE4ytt\xE4ytymisest\xE4si servulla. Toistaiseksi annamme korkeintaan kaksi porttikieltoa, joista\r j\xE4lkimm\xE4inen on aina ikuinen, jos ensimm\xE4inen on ollut yli viiden (5) p\xE4iv\xE4n mittainen." }),
                React.createElement(Accordion, { id: "pun2", question: "Mit\xE4 rankaisumenetelmi\xE4 teill\xE4 on olemassa?", target: "puncol2", answer: "Hiljennykset, varoitukset, sek\xE4 porttikiellot. Kolme varoitusta on\r aina viikon porttikielto." }),
                React.createElement(Accordion, { id: "pun3", question: "Sain rangaistuksen turhasta!", target: "puncol3", answer: "Liity Karanteenin Discordiin ja kerro asiasi #apua -kanavalla.\r Muista, ett\xE4 vaikka jokin ei olisi kielletty\xE4 s\xE4\xE4nn\xF6iss\xE4, siit\xE4 voidaan silti rangaista. Yll\xE4pit\xE4jien n\xE4kemykset voivat my\xF6s erota toisistaan, jonka vuoksi\r keskustele rangaistuksesta rangaistuksen antajan kanssa." })
            );
        }
    }]);
