    ...
    render() {
        return (
            <div className="col-lg-12 text-center">
                <div className="card card-body bg-dark-transparent border-aqua" style={{marginBottom: 1.2 + 'em', fontFamily: + 'Source Sans Pro' + '!important'}}>
...
function CmailImg(props) {
    return (
        <img src="assets/images/recipes/chainmail_armor.png" alt="" className="img-fluid" />
    )
}
...
function CoralImg(props) {
    return (
        <img src="assets/images/recipes/fire_coral.png" alt="" className="img-fluid" />
    )
}
...
function PlankImg(props) {
    return (
        <img src="assets/images/recipes/plank.png" alt="" className="img-fluid" />
    )
}
...
function PHeadImg(props) {
    return (
        <img src="assets/images/recipes/player_head.png" alt="" className="img-fluid" />
    )
}
...
function ZHeadImg(props) {
    return (
        <img src="assets/images/recipes/zombie_head.png" alt="" className="img-fluid" />
    )
}
...
function SkelHeadImg(props) {
    return (
        <img src="assets/images/recipes/skeleton_head.png" alt="" className="img-fluid" />
    )
}
...
function SmeltGImg(props) {
    return (
        <img src="assets/images/recipes/smelt_gravel.png" alt="" className="img-fluid" />
    )
}
...
function SmeltSImg(props) {
    return (
        <img src="assets/images/recipes/smelt_sand.png" alt="" className="img-fluid" />
    )
}
