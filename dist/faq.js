    ...
    _createClass(FrequentlyAskedQuestions, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(Accordion, { id: "yle3", question: "Apua! Ei ole oikeuksia komentoon, vaikka pit\xE4isi olla.", target: "ylecol3", answer: "Koita poistua palvelimelta ja liitty\xE4\r uudelleen. Mik\xE4li ongelma ei korjaantunut, nyk\xE4ise yll\xE4pit\xE4j\xE4\xE4 hihasta." }),
                ...
                React.createElement(Accordion, { id: "prot2", question: "Apua! Taloani on grieffattu!", target: "protcol2", answer: "Ei h\xE4t\xE4\xE4. P\xE4\xE4set Vaniljaj\xE4\xE4tel\xF6n Discordiin /discord komennolla, tai voit\r nyk\xE4ist\xE4 jo paikalla olevaa yll\xE4pit\xE4j\xE4\xE4 hihasta. Joka tapauksessa saat grieffatun talosi kuntoon, sek\xE4 tavarat takaisin. Grieffaaja sit\xE4 vastoin saa porttikiellon\r palvelimelle." }),
                ...
                React.createElement(Accordion, { id: "eco2", question: "Mit\xE4 valuuttaa palvelin k\xE4ytt\xE4\xE4 ja kuinka saan sit\xE4?", target: "ecol2", answer: ['Palvelimella rahavaluuttana toimivat vihreät kuulat.', 'Vihreitä kuulia saat hankkimalla uutta peliaikaa, sekä palvelinta äänestämällä ', React.createElement(
                        "code",
                        null,
                        "/vote"
                    ), '. Jokainen äänestykerta on 50 vihreän kuulan arvoinen.', React.createElement("br", null), 'Voit myös myydä sekä ostaa tavaraa käyttämällä arkkukauppoja.'] }),
                ...
                React.createElement(Accordion, { id: "pun3", question: "Sain rangaistuksen turhasta!", target: "puncol3", answer: "Liity Vaniljaj\xE4\xE4tel\xF6n Discordiin ja kerro asiasi #apua -kanavalla.\r Muista, ett\xE4 vaikka jokin ei olisi kielletty\xE4 s\xE4\xE4nn\xF6iss\xE4, siit\xE4 voidaan silti rangaista. Yll\xE4pit\xE4jien n\xE4kemykset voivat my\xF6s erota toisistaan, jonka vuoksi\r keskustele rangaistuksesta rangaistuksen antajan kanssa." }),
                React.createElement(Divider, { id: "modit", name: "Modit" }),
                React.createElement(Accordion, { id: "mod1", question: "Mitk\xE4 modit ovat sallittuja Vaniljaj\xE4\xE4tel\xF6ss\xE4?", target: "modcol1", answer: "P\xE4\xE4s\xE4\xE4nt\xF6isesti kaikki pelaajia hy\xF6dytt\xE4v\xE4t modit ovat kiellettyj\xE4, siin\xE4 miss\xE4 grafiikkamodit\r kuten OptiFine ovat sallittuja. Nyk\xE4ise yll\xE4pit\xE4j\xE4\xE4 hihasta mik\xE4li et ole varma." })
            );
        }
    }]);
