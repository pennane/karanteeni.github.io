...
var snowStorm = (function(window, document) {
  ...
  this.animationInterval = 50000;    // Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
  ...
  this.targetElement = document.getElementById("snowstorm");      // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
